...
const arrowClasses = document.getElementsByClassName('skills__arrow');
...
function screenSize(){
    if(screen.width > 968){
        ...
        for(i=0; i<arrowClasses.length; i++)
            arrowClasses[i].style.display = "none";
